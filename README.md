...
| --- | --- |
| [Spatial Vivid Toolkit](https://gitcode.com/UHD-World-Association/spatial-vivid-toolkit) | Reference toolkit for efficient 3DGS compression, GLB storage of 3DGS and related information, and HEIF/MP4 encapsulation. |
| [Spatial Vivid EGSC](https://gitcode.com/UHD-World-Association/spatial-vivid-egsc) | Efficient reference codec for 3D Gaussian Splatting. |
